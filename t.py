...
def _main():
    ...
    anchors_path = 'model_data/nuscenes_anchors.txt'
    ...
    model = create_model(input_shape, anchors, num_classes, weights_path='model_data/yolo.h5') # make sure you know what you freeze
