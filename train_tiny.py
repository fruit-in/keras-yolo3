...
def _main():
    ...
    anchors_path = 'model_data/tiny_nuscenes_anchors.txt'
    ...
    model = create_tiny_model(input_shape, anchors, num_classes, weights_path='model_data/yolo.h5') # make sure you know what you freeze
